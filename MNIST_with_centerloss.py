...
def visualize(feat, labels, epoch):
    ...
    plt.savefig('/home/dany/Documents/mnist_visual/softmax/images/epoch=%d.jpg' % epoch)
    plt.draw()
    plt.pause(0.001)
...
def main():
    ...
    # optimzer4center
    optimzer4center = optim.SGD(centerloss.parameters(), lr =0.01)
    ...
    for epoch in range(70):
        ...
        if (epoch + 1) >= 50:
            ...
            optimzer4center = torch.optim.Adam(model.parameters(), lr=0.0001)
            optimizer4nn = torch.optim.SGD(centerloss.parameters(), lr=0.001)
